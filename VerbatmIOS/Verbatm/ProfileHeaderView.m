...
-(void) changeBlogDescription {
	...
	CGFloat heightDiff = BLOG_DESCRIPTION_HEIGHT - self.blogDescription.frame.size.height;
...
-(UITextView *) blogTitleEditable {
	if (!_blogTitleEditable) {
		...
		[_blogTitleEditable addSubview: self.blogTitlePlaceholder];
	}
...
-(UITextView *) blogDescriptionEditable {
	if (!_blogDescriptionEditable) {
		...
		[_blogDescriptionEditable addSubview: self.blogDescriptionPlaceholder];
	}
...
-(UILabel *) blogTitlePlaceholder {
	if (!_blogTitlePlaceholder) {
		_blogTitlePlaceholder = [[UILabel alloc] initWithFrame: self.blogTitle.frame];
...
-(UILabel *) blogDescriptionPlaceholder {
	if (!_blogDescriptionPlaceholder) {
		_blogDescriptionPlaceholder = [[UILabel alloc] initWithFrame: self.blogDescription.frame];
