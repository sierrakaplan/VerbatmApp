...
#define SLIDESHOW_PROGRESS_CIRCLE_SIZE 25.f
#define SLIDESHOW_PROGRESS_CIRCLE_THICKNESS 5.f

#define VIDEO_PROGRESS_CIRCLE_SIZE 100.f
#define VIDEO_PROGRESS_CIRCLE_THICKNESS 10.0f
...
#define LIKE_SHARE_BAR_HEIGHT 250.f
...
#define TEXT_VIEW_OVER_MEDIA_MIN_HEIGHT 20.f
...
#define DISCOVER_USERNAME_AND_FOLLOW_HEIGHT 30.f
