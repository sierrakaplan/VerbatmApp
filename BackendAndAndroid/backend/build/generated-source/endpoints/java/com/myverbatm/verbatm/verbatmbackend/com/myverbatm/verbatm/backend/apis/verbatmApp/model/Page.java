...
public final class Page extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key @com.google.api.client.json.JsonString
  private java.util.List<java.lang.Long> imageIds;

  /**
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
  private java.lang.Integer indexInPOV;

  /**
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key @com.google.api.client.json.JsonString
  private java.util.List<java.lang.Long> videoIds;
  ...
  /**
   * @param imageIds imageIds or {@code null} for none
   */
  public Page setImageIds(java.util.List<java.lang.Long> imageIds) {
   ...
   * @return value or {@code null} for none
   */
  public java.lang.Integer getIndexInPOV() {
    return indexInPOV;
  }

  /**
   * @param indexInPOV indexInPOV or {@code null} for none
   */
  public Page setIndexInPOV(java.lang.Integer indexInPOV) {
  ...
  /**
   * @param videoIds videoIds or {@code null} for none
   */
  public Page setVideoIds(java.util.List<java.lang.Long> videoIds) {
