...
-(void) addTapGestuerToCustomImageScrollView: (VerbatmImageScrollView *) isv
{ 
...
-(void) createCustomImageScrollViewFromPinchView: (PinchView *) pinchView andImageView: (id)imageView orTextView: (VerbatmUITextView *) textView
{
